    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-24 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-8 mb-4">2. Accounts and Verification</h2>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Equity, compensation, intellectual property, or employment decisions</li>
            </ul>
            <p className="mt-4">Users are solely responsible for defining, documenting, and enforcing their own agreements.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Team formation or project success</li>
              <li>Acceptance by investors, sponsors, or institutions</li>
            </ul>
            <p className="mt-4">Any investor-related features are for <strong>discovery and evaluation only</strong> and do not constitute solicitation or endorsement.</p>
          </section>
          ...
          <section>
            ...
            <p>
              These Terms are governed by and construed in accordance with the laws of the <strong>United States</strong>, without regard to conflict of law principles.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Questions about these Terms may be sent to <a href="mailto:hello@yassu.co" className="text-primary hover:underline">hello@yassu.co</a>
            </p>
          </section>
        </div>
      </div>
