...
const journeySteps = [
  ...
  { id: 2, title: 'Business Plan', icon: Brain, description: "Generate with Bruin AI", segment: 'businessPlan', instructions: 'To regenerate: Go to Idea Overview > Improve your idea manually or with AI > Click "Regenerate" to create an improved business plan' },
  ...
  { id: 6, title: 'Bruin Foundry', icon: Rocket, description: 'Accelerate growth', segment: 'foundry' },
  ...
  const getStepStatus = (stepId: number): StepStatus => {
    switch (stepId) {
      ...
      case 5: // Build MVP - own signal based on MVP features
        ...
        return 'not_started';
      case 6: // Bruin Foundry - future feature, always not started for now
        return 'not_started';
...
<div class="header">
  <h1>${idea.title}</h1>
  <p class="subtitle">Business Plan generated by Bruin AI</p>
...
`;
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent>
            {!businessPlan ? (
              <div className="text-center py-8">
                ...
                <h3 className="font-semibold text-lg mb-2">Generate Bruin Business Plan</h3>
                <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                  Bruin AI will analyze your idea and generate a comprehensive business plan
                            ...
                            <div className="mt-8 pt-6 border-t">
                              ...
                              {loadingTeamMembers ? (
                                ...
                                <div className="text-center py-6 text-muted-foreground">
                                  ...
                                  <p className="text-sm mt-1">Invite people to join Bruin Entrepreneurs to grow your network!</p>
                                </div>
                              )}
                            </div>
                          )}
      ...
      {/* SEGMENT: Bruin Foundry - Events and Roadshows */}
      <motion.div
        ref={foundryRef}
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>Bruin Foundry</CardTitle>
